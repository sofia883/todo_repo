...
// // Also modify the _buildCategorySelector to remove the padding and adjust layout
...
// // In TodoList widget, update the AppBar and color usage:
//   @override
...
//                       progress = todo.isCompleted ? 1.0 : 0.0;
//                       this.setState(() {});
//                     });
//                     // ... rest of the onTap code
//                   },
//                   child: Padding(
...
//                                   ? Colors.grey[600]
//                                   : Colors
//                                       .black87, // Always black for better visibility
//                               fontSize: 16,
//                             ),
...
//         style: TextStyle(
//           color:
//               isSelected ? color.darker : Colors.black87, // Better visibility
...
// // Update the _buildCompletionCounter method:
...
//                 onSubmitted: (value) {
//                   _addNewTodo(value);
//                   // Request focus after adding todo
...
//             ),
//             IconButton(
//               icon: Icon(Icons.add, color: currentCategoryColor, size: 28),
//               onPressed: () {
//                 if (newTodoController.text.trim().isNotEmpty) {
//                   _addNewTodo(newTodoController.text);
//                   // Request focus after adding todo
